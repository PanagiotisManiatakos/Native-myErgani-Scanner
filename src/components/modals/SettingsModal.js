    ...
    <Dialog isVisible={show} onBackdropPress={() => setShow(false)}>
      ...
      <View className="flex flex-row justify-between my-2 align-center">
        <Pressable
          ...
          className="bg-gray-800 border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 rounded-lg px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700"
        >
